...
/*****************************************************************************/
{
  ...
  ssClear_manual_ = node_->create_service<slam_toolbox_camera::srv::Clear>(
    "slam_toolbox/clear_changes", std::bind(&LoopClosureAssistant::clearChangesCallback, 
    this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
  
  ssLoopClosure_ = node_->create_service<slam_toolbox_camera::srv::LoopClosure>(
  ...
  ssInteractive_ = node_->create_service<slam_toolbox_camera::srv::ToggleInteractive>(
